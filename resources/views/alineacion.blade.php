<x-layouts.app :title="__('Alineación')">
  ...
  ">
        ...
        <div id="jugador-modal"
            class="fixed inset-0 bg-opacity-60 hidden justify-center items-center z-50 overflow-y-auto">
        ...
        <div id="venta-modal" class="fixed inset-0 bg-opacity-60 hidden justify-center items-center z-50">
            <div class="bg-white p-6 rounded-lg w-11/12 max-w-md border border-gray-200 shadow-lg">
            ...
            div.querySelectorAll('.jugador-info').forEach(infoDiv => {
                infoDiv.addEventListener('click', () => {
                    ...
                    jugadorContent.innerHTML = `
                            ...
                            <div data-jugador-id="${jugador.id}" class="flex gap-6 items-center mb-6">
