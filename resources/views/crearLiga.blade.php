<x-layouts.app>
    <div class="min-h-screen bg-white flex flex-col items-center justify-start py-12 px-4">
        ...
        <div class="flex flex-wrap justify-center gap-6 w-full max-w-6xl">
            <!-- Tarjeta: Crear Liga -->
            <div class="relative text-black rounded-lg p-6 w-[600px] h-[700px] shadow-lg mt-4"
                style="background-color: #AD97C8;">
                <!-- Título -->
                ...
                <div class="flex justify-center">
                    <button
                        class="bg-gray-800 text-white px-6 py-3 rounded-md font-semibold hover:bg-gray-900 text-base">
                        CREAR
                    </button>
                </div>
            </div>
