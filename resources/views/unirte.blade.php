        ...
        <div class="flex flex-wrap justify-center gap-6 w-full max-w-6xl">
            ...
            <div class="relative text-black rounded-lg p-6 shadow-lg mt-4"
                ...
                <div class="flex items-center justify-between mb-6">
                    <span class="bg-[#3B0CA8] text-white px-4 py-2 rounded-md font-bold text-sm">ÚNETE A UNA
                        LIGA</span>
                </div>
                ...
                <form action="{{ route('league.code') }}" method="POST">
                    ...
                    <!-- Input de Código -->
                    <div class="mb-4">
                        <label for="league_code" class="block text-sm font-medium text-black">Código</label>
